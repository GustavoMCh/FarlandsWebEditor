      ...
      <>
          <div className='card text-left mt-3'>
            <div className="card-body">
              ...
              <b>Farlands</b> es una experiencia única, llena de descubrimientos, desafíos y momentos que solo tienen sentido si los vives por ti mismo. Te animamo encarecidamente a jugar el juego completo al menos una vez sin ayudas externas. La magia está en la exploración, en los errores, en las sorpresas… ¡y en construir tu propia historia!
              </p>
              ...
              <p className='card-text'>
              🛑 Úsala bajo tu propia responsabilidad. No me hago responsables por partidas corruptas, spoilers no deseados o la pérdida de la experiencia original del juego.
              </p>
              <br/>
